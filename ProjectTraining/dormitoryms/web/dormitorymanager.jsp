    ...
    <div class="row">
        <div class="col-sm-10">
            ...
            <div class="table-responsive">
                ...
                <!-- add框示例（Modal） -->
                <form method="post" action="/dormitory?method=save" class="form-horizontal" style="margin-top: 0px"
                      role="form"
                ...
                <!-- update框示例（Modal） -->
                <form method="post" action="/dormitory?method=update" class="form-horizontal" style="margin-top: 0px"
                      role="form"
                      id="form_data" style="margin: 20px;">
