...
<div class="head">
    <div class="head_zi">
        <div class="huan">
            <a href="manage.jsp"><%=request.getSession().getAttribute("user_id")%>
            </a>
            ,欢迎您
        </div>
        <div class="car">
...
<div class="shop">
    <div class="lunbo">
        ...
        <div id="lunbo">
            <div>
                <a href="#"><img src="images/Snipaste_2023-06-11_09-57-37.png"></a>
            </div>
            <div>
                <a href="#"><img src="images/pingban5.png"></a>
            </div>
            <div>
                <a href="#"><img src="images/Snipaste_2023-06-11_10-01-59.png"></a>
            </div>
            <div>
                <a href="#"><img src="images/Snipaste_2023-06-11_09-56-35.png"></a>
            </div>
            <div>
